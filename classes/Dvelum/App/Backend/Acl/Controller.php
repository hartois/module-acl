...
class Controller extends Backend\Ui\Controller
{
    ...
    public function indexAction()
    {
        ...
        $this->resource->addJs('/resources/dvelum-module-acl/js/app/system/Acl.js', true, 1);
        $this->resource->addJs('/resources/dvelum-module-acl/js/app/system/crud/acl.js', true, 2);
    ...
    {
        $projectData = [];
        $projectData['includes']['js'][] = '/resources/dvelum-module-acl/js/app/system/Acl.js';
        $module = $this->getModule();
        $projectData['includes']['js'][] = '/resources/dvelum-module-acl/js/app/system/desktop/' . strtolower($module) . '.js';
